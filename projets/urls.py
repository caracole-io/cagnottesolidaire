...
urlpatterns = [
    ...
    url(r'^projet/(?P<slug>[^/]+)/proposition$', PropositionCreateView.as_view(), name='proposition_create'),
    url(r'^projet/(?P<p_slug>[^/]+)/proposition/(?P<slug>[^/]+)$', PropositionDetailView.as_view(), name='proposition'),
    url(r'^projet/(?P<p_slug>[^/]+)/proposition/(?P<slug>[^/]+)/offre$', OffreCreateView.as_view(), name='offre_create'),
]
