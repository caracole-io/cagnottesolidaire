...
urlpatterns = [
    ...
    path('cagnotte/<str:slug>/proposition', views.PropositionCreateView.as_view(), name='proposition_create'),
    path('cagnotte/<str:p_slug>+)/proposition/<str:slug>', views.PropositionDetailView.as_view(), name='proposition'),
    path('cagnotte/<str:p_slug>/proposition/<str:slug>/offre', views.OffreCreateView.as_view(), name='offre_create'),
    ...
    path('demande/<str:slug>', views.DemandeCreateView.as_view(), name='demande_create'),
    path('demande/del/<int:pk>', views.DemandeDeleteView.as_view(), name='demande_delete'),
]
